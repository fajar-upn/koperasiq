		...
		<div class="row my-2">
			<div class="col">
						...
						<div class="col">
							<div class="row">
								<div class="col  text-center">
									<h3 class="font-weight-bold">Laporan SHU</h3>
								</div>
							</div>
							<div class="row">
								<div class="col text-center">
				...
				<hr class="m-0 mb-2">
					<div class="row mb-2">
						<div class="col-1">
							<form method="post" action="<?= base_url('admin/cetak_shu');?>" target="_blank">
											...
											<?php endif ?>
							<button type="submit" class="btn btn-secondary" style=""><i class="fa fa-file-pdf mr-1 d-none d-sm-inline"></i>Cetak</button>
							</form>
						</div>
						
						<div class="col-2">
							<a class="btn btn-danger" href="<?= base_url('admin/laporan_shu');?>">Reset</a>
						</div>
					</div>
									...
									<tbody>
										...
										<tr class="bg-dark text-white" >
												...
												<?php if (!empty($jumlah_pajak)): ?>
													<td style="border: 0px;">Sisa Hasil Usaha Setelah Pajak Per Desember <?= $tahun?></td>
												
												<?php else: ?>
													<td style="border: 0px;">Sisa Hasil Usaha Per Desember <?= $tahun?></td>
