...
<div class="row mb-2 mb-sm-0 mb-xl-2">
	...
	<?php endif ?>
		...
		<form method="post" action="<?= base_url();?>admin/cetak_bb" target="_blank">
			...
			<?php endif ?>
		<button type="submit" class="btn btn-dark" style="height: 100%; width: auto;"><i class="fa fa-file-pdf mr-2"></i>Cetak</button>
		...
		<form action="" method="post">
				<div class="input-group">
					  ...
					  <div class="input-group-append">
					    <button class="btn btn-dark" type="submit">Proses</button>
					 </div>
				</div>
				<input type="text" name="akun" id="akun" value="" hidden>
				<?php if ($this->input->post('tanggal_awal')): ?>
	...
	<div class="col-12 col-sm-4 col-md-4 col-xl-1">
        	<a class="btn btn-danger" href="<?= base_url();?>admin/buku_besar">Reset</a>
	</div>
