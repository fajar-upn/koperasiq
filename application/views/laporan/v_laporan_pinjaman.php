...
<div class="content-wrapper">
    ...
    <div class="row" style="padding-top: 20px">
      ...
      <div class="row">
        <div class="col-qw">
          ...
          >
            <div class="col-6">
              Data Pinjaman<strong> Berhasil</strong>
      ...
      <div class="row">
        <div class="col-8">
          ...
          >
            <div class="col-6">
              Data Pinjaman<strong> Gagal</strong>
              ...
              <div class="row">
                <div class="col-lg-12">
                  <div class="card p-2 shadow-sm">
                    <h4 class="text-center">Lihat Semua Pinjaman Anggota</h4>
                    <hr />
                    <form
                      action="<?= base_url('admin/lihat_pinjaman_all') ?>"
                      method="post"
                    >
                      <div class="form-row">
          ...
          >
            <div class="card-body">
              <div class="row">
                <div class="col-lg-12">
                  <div class="card p-2 shadow-sm">
                    <h4 class="text-center">Lihat Pinjaman Per Anggota</h4>
                    <hr />
                    <form
                      action="<?= base_url('admin/lihat_pinjaman_a') ?>"
                      method="post"
                    >
                      <div class="form-row">
                        <div class="form-group col-lg-12">
  ...
  <!-- <div style="margin-bottom: 1%" class="container col">
    <a id="formButton1" href="#" class="btn-sm"
      ><i class="fa fa-eye"></i> Lihat Semua Pinjaman Anggota</a
    >
  </div>
  ...
  <div style="margin-top: 3%; margin-bottom: 1%" class="container col">
    <a id="formButton" href="#" class="btn-sm"
      ><i class="fa fa-eye"></i> Lihat Pinjaman Per Anggota</a
    >
  </div>
