					...
					<div class="row">
						<div class="col-lg-12">
							...
							<div class="card p-2  shadow-sm">
								...
								<hr>
								<form action="<?= base_url('admin/lihat_simpanan_all') ?>" method="post">
									<div class="form-row">
					...
					<div class="row">
						<div class="col-lg-12">
							...
							<div class="card p-2  shadow-sm">
								...
								<hr>
								<form action="<?= base_url('admin/lihat_simpanan_a') ?>" method="post">
									<div class="form-row">
										<div class="form-group col-lg-12">
