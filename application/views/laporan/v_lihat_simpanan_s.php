          ...
          <div class="col">
            <div class="row mt-2">
              <div class="col-1">
                <a
                  role="button"
                  href="<?= base_url('admin/tampil_simpanan');?>"
              ...
              <div class="col-2">
                <form
                  ...
                  method="post"
                  action="<?= base_url('admin/cetak_simpanan');?>"
                  target="_blank"
                >
                  <input
                    type="text"
                ...
                <div class="table-responsive">
                  ...
                  >
                    ...
                    <tbody>
                      <tr>
                        <td>
                          <b><?= rupiah($total[0]['tsimpanan_pokok']) ?></b>
                        </td>
                        <td>
                          <b><?= rupiah($total[0]['tsimpanan_wajib']) ?></b>
                        </td>
                        <td>
                          <b><?= rupiah($total[0]['tsimpanan_sukarela']) ?></b>
                        </td>
                        <td>
                          <b><?= rupiah($total[0]['tsimpanan_lebaran']) ?></b>
                        </td>
                        <td>
                          <b
                            ><?= rupiah($total[0]['tsimpanan_pokok']+$total[0]['tsimpanan_wajib']+$total[0]['tsimpanan_sukarela']+$total[0]['tsimpanan_lebaran']) ?></b
                          >
                        </td>
                      </tr>
                    </tbody>
                  ...
                  >
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <?= rupiah($da['simpanan_pokok']+$da['simpanan_wajib']+$da['simpanan_sukarela']+$da['simpanan_lebaran']) ?>
                        </td>
                      </tr>
                      <?php endforeach; ?>
                    </tbody>
