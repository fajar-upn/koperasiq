						...
						<div class="row mt-2">
							...
							<div class="col-2">
								<form
									...
									method="post"
									action="<?= base_url('admin/cetak_simpanan_a');?>"
									target="_blank"
								>
									<input
										type="text"
								...
								<div class="table-responsive">
									...
									>
										...
										<tbody>
											...
											<tr>
												<td>
													<b><?= rupiah($da['simpanan_pokok']) ?></b>
												</td>
												<td>
													<b><?= rupiah($da['simpanan_wajib']) ?></b>
												</td>
												<td>
													<b><?= rupiah($da['simpanan_sukarela']) ?></b>
												</td>
												<td>
													<b><?= rupiah($da['simpanan_lebaran']) ?></b>
												</td>
												<td>
													<b
														><?= rupiah($da['simpanan_pokok']+$da['simpanan_wajib']+$da['simpanan_sukarela']+$da['simpanan_lebaran']) ?></b
													>
												</td>
											</tr>
											<?php endforeach; ?>
									...
									>
										...
										<tbody>
											...
											<tr>
												...
												<td>
													<a
														href="<?= base_url(); ?>admin/editsimpanan/<?= $da['id_simpanan']; ?>"
														class="btn-sm btn-success"
														><i class="fa fa-pen"></i
													></a>
													<a
														href="<?= base_url(); ?>admin/hapussimpanan/<?= $da['id_simpanan'];?>"
