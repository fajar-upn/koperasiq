          ...
          <div class="col">
            <div class="row mt-2">
              <div class="col-1">
                <a
                  role="button"
                  href="<?= base_url('admin/tampil_pinjaman');?>"
              ...
              <div class="col-2">
                <form
                  ...
                  method="post"
                  action="<?= base_url('admin/cetak_pinjaman');?>"
                  target="_blank"
                >
                  <input
                    type="text"
                  ...
                  >
                    <thead>
                      <tr class="table-primary text-center">
                        <th width="">
                          Total Pinjaman Posisi Per 31 Desember
                          <?= $tahun ?>
                        </th>
                        <th width="">
                          Total Sisa Pinjaman Posisi Per 31 Desember
                          <?= $tahun ?>
                        </th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr class="text-center">
                        <td>
                          <b><?= rupiah2($total[0]['sumtotal']) ?></b>
                        </td>
                        <td>
                          <b><?= rupiah2($total[0]['sumsisa']) ?></b>
                        </td>
                      </tr>
                    </tbody>
                  </table>
