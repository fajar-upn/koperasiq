									...
									<?php foreach($data_tb as $dt) : ?>
										<?php $hide = "hidden"; ?>
									 	<tr>
									  		...
									  		<td>
									  		<a href="<?= base_url(); ?>admin/ubahSaldoAwal/<?= $dt['id']; ?>" class="badge badge-success">Update</a>
						  					<a href="<?= base_url(); ?>admin/hapusSaldoAwal/<?= $dt['id'];?>" class="badge badge-danger ml-1">Hapus</a>
						  					</td>
									  	</tr>
