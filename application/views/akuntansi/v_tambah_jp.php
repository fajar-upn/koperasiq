...
<?php endif; ?>
          <!-- Page Heading -->
  <h1 class="h3 mb-4 text-gray-800">Tambah Penyesuaian</h1>

<form action="<?= base_url('admin/tambah_jp') ?>" method="post" name="formtransaksi">
...
<div class="content" id="form-debit">
	...
	<div class="row mt-2 ">
		...
		<div class="col-12 text-center mb-2">
				...
				<a class="btn btn-primary" href="<?= base_url('admin/jurnal_penyesuaian');?>">Kembali</a>
