		...
		<div class="col">
				...
				<div class="row">
					...
					<div class="col text-center">
						<h2><strong>Jurnal Umum</strong></h2>
					</div>
	...
	<div class="row mb-2 mb-sm-0 mb-xl-2">
		<?php if ($role == 'admin'): ?>
			<div class="col-12 col-sm-8 col-md-8 mb-2 mb-xl-0 col-xl-3">
				<a href="<?= base_url();?>admin/transaksi_m" class="btn btn-success" style="width: 100%;">Tambah Data</a>
			</div>
		...
		<?php endif ?>
			...
			<form method="post" action="<?= base_url();?>admin/cetak_ju" target="_blank">
					  <?php if ($this->input->post('tanggal_awal')): ?>
		...
		<div class="col-12 col-sm-4 col-md-4 col-xl-1 ">
			<a class="btn btn-danger" href="<?= base_url();?>admin/jurnal_umum">Reset</a>
		</div>
	</div>
	<div class="row">
				  ...
				  <div class="table-responsive">
                   <table class="table table-bordered text-center" width="100%" cellspacing="0">
			  		...
			  		<?php foreach ($jurnal_umum as $ju ) : ?>
					  	...
					  	<?php if ($ju['ref'] == 'JP'): ?>
					  		<!-- Mengkosongkan Keterangan Jurnal Penyesuaian -->
					  			<?php $totaljp_d[] = $ju['debit']; ?>
					  			<?php $totaljp_k[] = $ju['kredit']; ?>
						<?php else: ?>
					  		<tr>
							  	...
							  	<?php else : ?>
						  			...
						  			<td style="border-bottom: 0px;"><?= $ju['keterangan'] ?></td>
							  		...
							  		<?php if ($role == 'admin'): ?>	
							  				...
							  				<a href="<?= base_url(); ?>admin/ubahtransaksi_ju/<?= $ju['bukti_transaksi']; ?>" class="btn btn-sm btn-success"><i class="fa fa-pen"></i></a>
							  				<a href="<?= base_url(); ?>admin/hapustransaksi_ju/<?= $ju['bukti_transaksi'];?>" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></a>
							  				</td>
							  		<?php endif ?>
					  			<?php endif ?>
