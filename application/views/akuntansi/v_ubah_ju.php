			  ...
			  <div class="card mb-2">
			  	<div class="form-row p-2">
				    <div class="col-12 col-sm-12 col-md-4">
				      ...
				      <input value="<?= $transaksi['bukti_transaksi'][0]; ?>" type="text" class="form-control" id="bukti_copy" name="bukti_copy" onkeyup="auto_copy();" readonly>
...
<div class="content" id="form-debit">	
          	...
          	<div class="card">
              	...
              	<div class="card-body">              			          			
		          		...
		          		<div class="form-group col">
			          		...
			          		<option value="" selected >-- Pilih Kode Akun --</option>	
						        <?php foreach ($dd_kodeakun as $dd) : ?>
						        	<?php if ($dd->kode_akun == $transaksi['kode_akun'][0]) : ?>
		          			...
		          			<!-- ID Hidden -->
		          			<input type="text" class="form-control tanggal_transaksi4" name="id[]" id="id1" value="<?=  $transaksi['id'][0];?>" hidden>
		          			
		          			<!-- <h5>Tanggal HIDDEN</h3> -->
		          			<input type="text" class="form-control" name="tanggal_transaksi[]" id="tanggal_transaksi" value="<?=$transaksi['tanggal_transaksi'][0]; ?>" hidden>
		          	...
		          	<div class="form-row justify-content-around mt-2">
		          		<div class="form-group col">
		          			<h5>Pos Laporan</h3>
						      <input type="text" class="form-control" name="pos_laporan[]" id="pos_laporan" value="<?= $transaksi['pos_laporan'][0]; ?>" readonly>
		          		</div>
		          		<div class="form-group col">
		          			<h5>Pos Akun</h5>
						      <input type="text" class="form-control" name="pos_akun[]" id="pos_akun" value="<?= $transaksi['pos_akun'][0]; ?>" readonly>
		          		</div>		        	          		
		          	</div>
		         		...
		         		<div class="form-group col">
						      ...
						      <select class="form-control" name="pos_saldo[]" id="pos_saldo" onchange="nonaktifDebitKredit()">
						        <?php foreach ($pos_saldo as $ps) : ?>
						        	<?php if ($ps == $transaksi['pos_saldo'][0]) : ?>
          	...
          	<div class="card">
              	...
              	<div class="card-body"> 
		          	...
		          	<div class="form-row justify-content-around">
		          		...
		          		<div class="form-group col">
		          			...
		          			<select name="kode_akun[]" id="kode_akun1" class="form-control" >
			          			<option value="" selected >-- Pilih Kode Akun --</option>
			          			<?php foreach ($dd_kodeakun as $dd) : ?>
						        	<?php if ($dd->kode_akun == $transaksi['kode_akun'][1]) : ?>
						        		<option value="<?= $dd->kode_akun; ?>" selected><?= $dd->kode_akun; ?> -- <?= $dd->akun; ?></option>
						        	<?php else : ?>
						       			<option value="<?= $dd->kode_akun; ?>"><?= $dd->kode_akun; ?> -- <?= $dd->akun; ?></option>	
						        	<?php endif; ?>
		          	...
		          	<div class="form-row justify-content-around mt-2">
		          		<div class="form-group col">
		          			<h5>Pos Laporan</h3>
						      <input type="text" class="form-control" name="pos_laporan[]" id="pos_laporan1" value="<?= $transaksi['pos_laporan'][1]; ?>" readonly>
		          		</div>
		          		<div class="form-group col">
		          			<h5>Pos Akun</h5>
						      <input type="text" class="form-control" name="pos_akun[]" id="pos_akun1" value="<?= $transaksi['pos_akun'][1]; ?>" readonly>
		          		</div>		        	          		
		          	</div>
		          	...
		          	<div class="form-row mt-2">
		         		<div class="form-group col">
						      ...
						      <select class="form-control" name="pos_saldo[]" id="pos_saldo1" onchange="nonaktifDebitKredit1()">
						         <?php foreach ($pos_saldo as $ps) : ?>
						        	<?php if ($ps == $transaksi['pos_saldo'][1]) : ?>
						        		<option value="<?= $ps ?>" selected><?= $ps; ?></option>
						        	<?php else : ?>
						       			<option value="<?= $ps ?>"><?= $ps; ?></option>	
						        	<?php endif; ?>
          		...
          		<div class="card-header text-center bg-primary">
              	 ...
              	 <?php endif; ?>
		     	 	...
		     	 	<div class="form-row justify-content-around">
		          		...
		          		<div class="form-group col">
		          			...
		          			<select name="kode_akun[]" id="kode_akun2" class="form-control" >
			          			<option value="" selected >-- Pilih Kode Akun --</option>
			          			<?php foreach ($dd_kodeakun as $dd) : ?>
						        	<?php if ($dd->kode_akun == $transaksi['kode_akun'][2]) : ?>
						        		<option value="<?= $dd->kode_akun; ?>" selected><?= $dd->kode_akun; ?> -- <?= $dd->akun; ?></option>
						        	<?php else : ?>
						       			<option value="<?= $dd->kode_akun; ?>"><?= $dd->kode_akun; ?> -- <?= $dd->akun; ?></option>	
						        	<?php endif; ?>
		          	...
		          	<div class="form-row justify-content-around mt-2">
		          		<div class="form-group col">
		          			<h5>Pos Laporan</h3>
						      <input type="text" class="form-control" name="pos_laporan[]" id="pos_laporan2" value="<?= $transaksi['pos_laporan'][2]; ?>" readonly >
		          		</div>
		          		<div class="form-group col">
		          			<h5>Pos Akun</h5>
						      <input type="text" class="form-control" name="pos_akun[]" id="pos_akun2" value="<?= $transaksi['pos_akun'][2]; ?>" readonly>
		          		</div>		        	          		
		          	</div>
		          	...
		          	<div class="form-row mt-2">
		         		<div class="form-group col">
						      ...
						      <select  class="form-control" name="pos_saldo[]" id="pos_saldo2" onchange="nonaktifDebitKredit2()">
						         <?php foreach ($pos_saldo as $ps) : ?>
						        	<?php if ($ps == $transaksi['pos_saldo'][2]) : ?>
						        		<option value="<?= $ps ?>" selected><?= $ps; ?></option>
						        	<?php else : ?>
						       			<option value="<?= $ps ?>"><?= $ps; ?></option>	
						        	<?php endif; ?>
              	...
              	<div class="card-body"> 
              	 ...
              	 <?php endif; ?>
		          	...
		          	<div class="form-row justify-content-around">
		          		...
		          		<div class="form-group col">
		          			...
		          			<select name="kode_akun[]" id="kode_akun3" class="form-control" >
			          			<option value="" selected >-- Pilih Kode Akun --</option>
			          			<?php foreach ($dd_kodeakun as $dd) : ?>
						        	<?php if ($dd->kode_akun == $transaksi['kode_akun'][3]) : ?>
						        		<option value="<?= $dd->kode_akun; ?>" selected><?= $dd->kode_akun; ?> -- <?= $dd->akun; ?></option>
						        	<?php else : ?>
						       			<option value="<?= $dd->kode_akun; ?>"><?= $dd->kode_akun; ?> -- <?= $dd->akun; ?></option>	
						        	<?php endif; ?>
		          	...
		          	<div class="form-row justify-content-around mt-2">
		          		<div class="form-group col">
		          			<h5>Pos Laporan</h3>
						      <input type="text" class="form-control" name="pos_laporan[]" id="pos_laporan3" value="<?= $transaksi['pos_laporan'][3]; ?>" readonly >
		          		</div>
		          		<div class="form-group col">
		          			<h5>Pos Akun</h5>
						      <input type="text" class="form-control" name="pos_akun[]" id="pos_akun3" value="<?= $transaksi['pos_akun'][3]; ?>" readonly>
		          		</div>			        	          		
		          	</div>
		          	...
		          	<div class="form-row mt-2">
		         		<div class="form-group col">
						      ...
						      <select class="form-control"  name="pos_saldo[]" id="pos_saldo3" onchange="nonaktifDebitKredit3()">
						          <?php foreach ($pos_saldo as $ps) : ?>
						        	<?php if ($ps == $transaksi['pos_saldo'][3]) : ?>
						        		<option value="<?= $ps ?>" selected><?= $ps; ?></option>
						        	<?php else : ?>
						       			<option value="<?= $ps ?>"><?= $ps; ?></option>	
						        	<?php endif; ?>
	...
	<div class="row mt-2 ">
		...
		<div class="col-12 text-center mb-2">
				...
				<a class="btn btn-primary" href="<?= base_url('admin/jurnal_umum');?>">Kembali</a>
