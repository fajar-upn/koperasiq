				...
				<div class="row mb-2 mb-sm-0 mb-xl-2">
					<?php if ($role == 'admin'): ?>
						<div class="col-12 col-sm-8 col-md-8 mb-2 mb-xl-0 col-xl-3">
							<a role="button" href="<?= base_url('admin/tambah_jp');?>" class="btn btn-success" style="width: 100%;">Tambah Data</a>
						</div>
					...
					<?php endif ?>
						...
						<form method="post" action="<?= base_url();?>admin/cetak_jp" target="_blank">
							<?php if ($this->input->post('tanggal_awal')): ?>
					...
					<div class="col-12 col-sm-4 col-md-4 col-xl-1">
						<a class="btn btn-danger" href="<?= base_url();?>admin/jurnal_penyesuaian">Reset</a>
					</div>
				</div>
				<div class="row">
								...
								<table class="table table-bordered text-center" width="100%" cellspacing="0">
									<thead>
										<tr class="table-primary">
											...
											<th width="11%">Bukti Transaksi</th>
										...
										<tr>
											...
											<?php else : ?>
												...
												<?php if ($role == 'admin'): ?>
													...
													<a href="<?= base_url(); ?>admin/update_jp/<?= $ju['bukti_transaksi']; ?>" class="btn btn-sm mr-1 btn-success mb-1 mb-xl-0"><i class="fa fa-pen"></i></a>
													<a href="<?= base_url(); ?>admin/hapus_jp/<?= $ju['bukti_transaksi'];?>" class="btn btn-sm mr-1 btn-danger"><i class="fa fa-trash"></i></a>
													</td>		
