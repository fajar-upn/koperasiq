		    ...
		    <!-- <div class="card mb-4">
		    	<div class="row p-4">
		    		<div class="col-12 col-md-4 mb-2 mb-md-0 text-center">
		    			<a href="<?= base_url() ?>master/kas_masuk" class="btn btn-dark align-items-center" style="height: 50px; width: 200px;">
		    				<h5 class="m-1">Kas Masuk</h5>
		    			</a>
		    		</div>
		    		<div class="col-12 col-md-4 mb-2 mb-md-0 text-center" >
		    			<a href="<?= base_url() ?>master/kas_keluar" class="btn btn-dark" style="height: 50px; width: 200px;">
		    				<h5 class="m-1">Kas Keluar</h5>
		    			</a>
		    		</div>
		    		<div class="col-12 col-md-4 mb-2 mb-md-0 text-center">
		    			<a href="<?= base_url(); ?>admin/jurnal_umum" class="btn btn-dark" style="height: 50px; width: 200px;">
